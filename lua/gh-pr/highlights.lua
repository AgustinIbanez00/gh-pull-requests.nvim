...
local baseline_links = {
  ...
  { "GhPrDiffReviewChangeAdd", "DiffAdd" },
  { "GhPrDiffReviewChangeMod", "DiffChange" },
  { "GhPrDiffReviewChangeDel", "DiffDelete" },
  { "GhPrDiffReviewActiveHunk", "CursorLine" },
  { "GhPrDiffReviewSectionHeader", "Title" },
  { "GhPrDiffReviewCounter", "Comment" },
  { "GhPrCommentableZone", "DiagnosticHint" },
  { "GhPrActivity", "PmenuSel" },
  { "GhPrActivityBorder", "FloatBorder" },
  { "GhPrCreateTab", "TabLine" },
  { "GhPrCreateTabActive", "TabLineSel" },
  { "GhPrCreateTabDone", "DiagnosticOk" },
  { "GhPrCreateTabWarn", "DiagnosticWarn" },
  { "GhPrCreateMuted", "Comment" },
  { "GhPrCreateHint", "Identifier" },
}
