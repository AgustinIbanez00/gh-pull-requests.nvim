...
local baseline_links = {
  ...
  { "GhPrOverviewTimelineComment", "DiagnosticInfo" },
  { "GhPrOverviewTimelineReview", "DiagnosticWarn" },
  { "GhPrOverviewTimelineThread", "Identifier" },
  { "GhPrOverviewTimelineCommit", "Special" },
  { "GhPrOverviewTimelinePrChange", "Type" },
