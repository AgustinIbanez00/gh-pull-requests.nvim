...
local function set_pr_buffer_keymaps(bufnr, keymap_opts)
  ...
  local managed_normal = {
    ...
    diff_shortcuts.toggle_review_panel,
  ...
  set_buffer_keymap("n", diff_shortcuts.toggle_review_panel, call_action("toggle_diff_review_panel"), "Toggle diff review panel")
